...
import com.pdf.service.IPdfService;
...
public class PdfController {
	...
	public String pdfMap(Model model){
	    ...
	    @RequestMapping("/pdf/list.do") //View에서 맵핑 url 주소
	    public ModelAndView list(int reNo) throws Exception {
	        String result = service.createPdf(reNo); //createPdf()메소드에서 pdf파일이 생성되었는지 결과가 result에 담긴다.
